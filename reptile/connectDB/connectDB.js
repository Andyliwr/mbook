...
var factionRankSchema = new mongoose.Schema({
  qiDian:{
    total: [], //汇总排名, 每一项包含factionName, author，headImg，最后stringfy成一个字符串存进去
    xuanhuan: [], //玄幻排名
    yanqing: [], //言情排名
    wuxia: [], //武侠排名
    lishi: [], //历史排名
...
var initDB = function () {
  ...
  //创建排名的实例
  var factionRankEntity = new factionRankModel({
    qiDian:{
      total: [],
      xianhuan: ["{'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"],
      yanqing: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"],
      wuxia: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"],
      lishi: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"],
      kehuan: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"]
    },
    zongHeng: {
      total: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"],
      xianhuan: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"],
      yanqing: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"],
      wuxia: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"],
      lishi: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"],
      kehuan: ["{'rank': '1', 'factionName': '大主宰', 'author': '烟雨江南', 'headImg': 'xxxx', 'des': 'xxxxx'}"]
  ...
  factionRankEntity.save(function(err){
    if (err) {
      logger.warn('小说排行榜初始化失败....'+err);
    }else{
      logger.info('小说排行榜初始化成功....');
    }
  });
  //关闭数据库链接
  // db.close();
