...
module.exports = function (Rank) {
  //定义一个简单的远程方法
  Rank.greet = function (msg, cb) {
    //然后使用Rank.app获取到app对象
    var app = Rank.app;
    //获取datasources
    ...
    // console.log(app.models.book.find({}));
  ...
  //单独获取起点小说排行榜
  Rank.getRank = function (rankType, cb) {
    var app = Rank.app;
    var returnData = {};
    var resultArr = [];
    app.models.rank.find(function (err, sourceData) {
      if(err){
